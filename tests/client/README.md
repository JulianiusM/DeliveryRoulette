...
This directory contains comprehensive frontend tests for the DeliveryRoulette application. These tests run **without a backend** and use MSW (Mock Service Worker) to intercept and mock HTTP requests.
