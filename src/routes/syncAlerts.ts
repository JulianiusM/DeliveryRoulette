...
router.post('/:id/dismiss', requireAdmin, asyncHandler(async (req: Request, res: Response) => {
...
router.post('/dismiss-all', requireAdmin, asyncHandler(async (req: Request, res: Response) => {
